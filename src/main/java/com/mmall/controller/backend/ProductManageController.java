...
public class ProductManageController {
    ...
    public ServerResponse productSave(HttpSession session,Product product){
        ...
        if(user == null){
            return ServerResponse.createByErrorCodeMessage(ResponseCode.NEED_LOGIN.getCode(),"you have to login admin!");
        }
        if(iUserService.checkAdminRole(user).isSuccess()){
            return iProductService.saveOrUpdateProduct(product);
        }else{
            return ServerResponse.createByErrorMessage("you do not a admin!");
        }
    }
       ...
       Map resultMap = Maps.newHashMap();
        ...
        if(iUserService.checkAdminRole(user).isSuccess()){
            ...
            if(StringUtils.isBlank(targetFileName)){
                resultMap.put("success",false);
                resultMap.put("msg","upload faild");
                return resultMap;
            }
            String url = PropertiesUtil.getProperty("ftp.server.http.prefix")+targetFileName;
            ...
            resultMap.put("success",false);
            resultMap.put("msg","you do not have permission!");
            return resultMap;
        }
